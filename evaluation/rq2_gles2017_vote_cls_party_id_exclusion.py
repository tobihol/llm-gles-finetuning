...
from helpers.data_preprocessing import DatasetGLES2017
...
for party in [
    ...
    exp_config["excluded_party_id"] = party

    splits_gen = DATASET.classification_splits(
        target_col=TARGET_COL,
        splits=CROSS_VALIDATOR,
        train_mask=(
            lambda df: df["Parteiidentifikation"] != party
        ),
    )
